...
namespace GestionarVE.Controllers
{
    public class EstadoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EstadoID,Descrption,Active")] Estado estado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EstadoID,Descrption,Active")] Estado estado)
        {
            if (ModelState.IsValid)
            {
